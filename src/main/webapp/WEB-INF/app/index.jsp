...
<%
    UsersStorage storage = (UsersStorage) session.getAttribute("storage");
...
<div class="container ">
    <div class="row center-block">
        <div class="jumbotron text-center">
            <div class="grid_4  ">
                <h3>Hello, <%=session.getAttribute("login")%>
                </h3>
            </div>
        </div>
    </div>
    <div class="list-group">
        ...
        <a href="/changePassword.htm" class="list-group-item">Change password</a>
        <%if (storage.getPermission() == 7) {%>
